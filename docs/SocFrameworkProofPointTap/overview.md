...
| Pack | System | Source |
|---|---|---|
| `SocFrameworkProofPointTap.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/SocFrameworkProofPointTap-v1.5.6/SocFrameworkProofPointTap-v1.5.6.zip) |
